...
public class Bayes extends Configured implements Tool {
    ...
    public static class BayesMapper extends Mapper<Text, BytesWritable, Text, Text> {
		...
		protected void setup(Mapper<Text, BytesWritable, Text, Text>.Context context)
			...
			Path allWordNumInClass = new Path("hdfs://master:9000/WordNumInDoc/part-r-00000");
			...
			IntWritable valueOfDocNumInClass = new IntWritable();
	...
	public static class BayesReducer extends Reducer<Text, Text, Text, Text> {
	...
	public int run(String[] args) throws Exception {
		...
		Path outputPath = new Path("hdfs://master:9000/BayesResult");
...
//		conf.set("CLASSGROUP", "AFGH/ANTA/USA/CHINA/");
		...
		SequenceFileInputFormat.addInputPath(job, new Path("hdfs://master:9000/SerializationTrainData_test"));
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new Bayes(), args);
		System.exit(res);
	}
}
package qi.hadoop.bayes;
